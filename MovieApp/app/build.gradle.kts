...
dependencies {
    ...
    implementation("androidx.lifecycle:lifecycle-runtime-ktx:2.9.0-alpha02")
    ...
    // Optional: Coil for image loading (good practice for real APIs)
    implementation("io.coil-kt:coil:2.6.0")

    // Testing dependencies (important for writing tests)
